...
import com.sobolevski.senla.onlinebook.action.DeleteCustomerAction;
import com.sobolevski.senla.onlinebook.action.DeleteOrderAction;
import com.sobolevski.senla.onlinebook.action.DeleteWriterAction;
import com.sobolevski.senla.onlinebook.action.ExportBookAction;
import com.sobolevski.senla.onlinebook.action.ExportCustomerAction;
import com.sobolevski.senla.onlinebook.action.ExportOrderAction;
import com.sobolevski.senla.onlinebook.action.ExportWriterAction;
import com.sobolevski.senla.onlinebook.action.ImportCustomerAction;
import com.sobolevski.senla.onlinebook.action.ImportWriterAction;
...
import com.sobolevski.senla.onlinebook.action.SortBookNameAction;
import com.sobolevski.senla.onlinebook.action.SortBookPriceAction;
import com.sobolevski.senla.onlinebook.action.SortBookQuantutyAction;
import com.sobolevski.senla.onlinebook.action.SortCustomerByNameAction;
import com.sobolevski.senla.onlinebook.action.SortOrderByDateAction;
import com.sobolevski.senla.onlinebook.action.SortWriterNameAction;
...
public class BilderMenu {
	...
	public BilderMenu() {
		...
		IMenu menubook4 = new Menu("Print sort Book Name", 4, new SortBookNameAction());
		IMenu menubook5 = new Menu("Print sort Book Price", 5, new SortBookPriceAction());
		IMenu menubook6 = new Menu("Print sort Book Quantity", 6, new SortBookQuantutyAction());
		IMenu menubook7 = new Menu("Export book in CSV", 7, new ExportBookAction());
		IMenu menubook8 = new Menu("Import book with CSV", 8);
		...
		IMenu menuorder3 = new Menu("Delete order", 3,new DeleteOrderAction());
		IMenu menuorder4 = new Menu("Print sort  order Date", 4,new SortOrderByDateAction());
		IMenu menuorder5 = new Menu("Export order in CSV", 5, new ExportOrderAction());
		...
		IMenu menuwriter3 = new Menu("Delete writer", 3,new DeleteWriterAction());
		IMenu menuwriter4 = new Menu("Print sort  writer name", 4,new SortWriterNameAction());
		IMenu menuwriter5 = new Menu("Export writer in CSV", 5, new ExportWriterAction());
		IMenu menuwriter6 = new Menu("Import writer with CSV", 6, new ImportWriterAction());
		...
		IMenu menucustomer3 = new Menu("Delete customer", 3,new DeleteCustomerAction());
		IMenu menucustomer4 = new Menu("Print sort  customer name", 4,new SortCustomerByNameAction());
		IMenu menucustomer5 = new Menu("Export customer in CSV", 5, new ExportCustomerAction());
		IMenu menucustomer6 = new Menu("Import customer with CSV", 6, new ImportCustomerAction());
