...
public class BilderMenu {
	...
	public BilderMenu() {
		...
		IMenu menu4 = new Menu("Import/export", 4);
		...
		menu4.setMenuList(menuexportorder);
		menu4.setMenuList(menuexportbook);
		menu4.setMenuList(menuimportorder);
		menu4.setMenuList(menuimportbook);
		menu4.setMenuList(exit);
