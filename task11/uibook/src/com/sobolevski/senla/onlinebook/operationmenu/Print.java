...
public class Print {
	...
	private String printInfoWriterOll(Object writer) {
		...
		stringbuilder.append(((IWriter) writer).getIdWriter());
		stringbuilder.append(LASTNAME_WRITER);
		stringbuilder.append(((IWriter) writer).getLastname());
		stringbuilder.append(FIRSTNAME_WRITER);
		stringbuilder.append(((IWriter) writer).getFirstname());
		stringbuilder.append(DATE_START);
		stringbuilder.append(((IWriter) writer).getStartYear());
		stringbuilder.append(DATE_DIED);
		stringbuilder.append(((IWriter) writer).getDiedYear());
	...
	private String printInfoCustomerOll(Object customer) {
		...
		stringbuilder.append(((ICustomer) customer).getIdCustomer());
		stringbuilder.append(LASTNAME_CUSTOMER);
		stringbuilder.append(((ICustomer) customer).getLastname());
		stringbuilder.append(FIRSTNAME_CUSTOMER);
		stringbuilder.append(((ICustomer) customer).getFirstname());
		stringbuilder.append(PHONE_CUSTOMER);
		stringbuilder.append(((ICustomer) customer).getPhone());
		return stringbuilder.toString();
	}
	...
	private String printInfoBook(Object book) {
		...
		stringbuilder.append(((IBook) book).getIdBook());
		stringbuilder.append(ID_WRITER2);
		stringbuilder.append(((IBook) book).getWriter().getIdWriter());
		stringbuilder.append(NAME_BOOK);
		stringbuilder.append(((IBook) book).getNameBook());
	...
	private String printInfoOrderOll(Object order) {
		StringBuilder stringbuilder = new StringBuilder();
		stringbuilder.append(FIRSTNAME_CUSTOMER);
		stringbuilder.append(((IOrder) order).getCustomer().getFirstname());
		stringbuilder.append(LASTNAME_CUSTOMER);
		stringbuilder.append(((IOrder) order).getCustomer().getLastname());
		stringbuilder.append(NAME_BOOK);
		stringbuilder.append(((IOrder) order).getBook().getNameBook());
		stringbuilder.append(PRICE_BOOK);
		stringbuilder.append(((IOrder) order).getBook().getPrice());
		stringbuilder.append(DATE_ORDER);
		stringbuilder.append(((IOrder) order).getDateOrder());
		return stringbuilder.toString();
	}
